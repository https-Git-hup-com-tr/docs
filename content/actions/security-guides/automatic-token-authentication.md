...
Before each job begins, {% data variables.product.prodname_dotcom %} fetches an installation access tokqen for the job. {% data reusables.actions.github-token-expiration %}
